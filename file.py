...
class ImageEffects():
    ...
    def ColorGradient(self, array, rainbwRow, rowHeight='NONE'):
        ...
        while self.rainbwRow > 0:
            self.array = self.AddaBox(self.array, self.rainbwRow, 250,
...
class WindowApp(PictureEdit):
    ...
    def __init__(self, master):
        ...
        self.BrushButton = Button(self.ToolBoxFrame, width=20, height=20, text='bb', bd=0, cursor="hand2",
        ...
        # camera edit button
        self.PicEditButton = Button(self.ToolBoxFrame, text="C", width=20, height=20, bd=0, cursor='hand2',
                                    command=self.ShowPicEditor)
    ...
    def Draw(self, event, thickness=5):
        try:
            ...
            self.point = self.DrawCanvas.create_oval(self.x, self.y, self.x + self.thickness, self.y + self.thickness,
...
class EditWindow(MovableWindow):
    ...
    def BrushEffects(self):
        ...
        # slider
        self.BrushThickness = Scale(self.editWin, from_=0, to=100, orient=HORIZONTAL, width=10, bd=0, bg="#333",
                                    fg='white', \
                                    length=250)
        ...
        self.SetBrushThicknessBtn = Button(self.editWin, width=20, height=20, text='v', bd=0,
                                           command=self.refreshBrushthk, cursor="hand2")
